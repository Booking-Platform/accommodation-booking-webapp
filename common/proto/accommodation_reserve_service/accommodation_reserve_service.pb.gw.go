...
func RegisterAccommodationReserveServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AccommodationReserveServiceServer) error {
	...
	mux.Handle("GET", pattern_AccommodationReserveService_CancelReservation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AccommodationReserveService_CancelReservation_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AccommodationReserveService_CancelReservation_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAccommodationReserveServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AccommodationReserveServiceClient) error {
	...
	mux.Handle("GET", pattern_AccommodationReserveService_CancelReservation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AccommodationReserveService_CancelReservation_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	forward_AccommodationReserveService_CancelReservation_0 = runtime.ForwardResponseMessage
)
