...
var (
	filter_AccommodationReserveService_Get_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_AccommodationReserveService_Get_0(ctx context.Context, marshaler runtime.Marshaler, client AccommodationReserveServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_AccommodationReserveService_Get_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_AccommodationReserveService_Get_0(ctx context.Context, marshaler runtime.Marshaler, server AccommodationReserveServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetRequest
	var metadata runtime.ServerMetadata
...
func RegisterAccommodationReserveServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AccommodationReserveServiceServer) error {
	...
	mux.Handle("GET", pattern_AccommodationReserveService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/catalogue.AccommodationReserveService/Get", runtime.WithHTTPPathPattern("/david"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AccommodationReserveService_Get_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_AccommodationReserveService_Get_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAccommodationReserveServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AccommodationReserveServiceClient) error {
	...
	mux.Handle("GET", pattern_AccommodationReserveService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/catalogue.AccommodationReserveService/Get", runtime.WithHTTPPathPattern("/david"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AccommodationReserveService_Get_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_AccommodationReserveService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"david"}, ""))
)

var (
	forward_AccommodationReserveService_Get_0 = runtime.ForwardResponseMessage
)
