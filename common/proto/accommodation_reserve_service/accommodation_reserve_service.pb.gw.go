...
func request_AccommodationReserveService_DeleteAllUserReservations_0(ctx context.Context, marshaler runtime.Marshaler, client AccommodationReserveServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteAllUserReservationsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.DeleteAllUserReservations(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AccommodationReserveService_DeleteAllUserReservations_0(ctx context.Context, marshaler runtime.Marshaler, server AccommodationReserveServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteAllUserReservationsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.DeleteAllUserReservations(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterAccommodationReserveServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AccommodationReserveServiceServer) error {
	...
	mux.Handle("DELETE", pattern_AccommodationReserveService_DeleteAllUserReservations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/accommodation_reserve.AccommodationReserveService/DeleteAllUserReservations", runtime.WithHTTPPathPattern("/api/reservation/deleteAll/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AccommodationReserveService_DeleteAllUserReservations_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AccommodationReserveService_DeleteAllUserReservations_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAccommodationReserveServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AccommodationReserveServiceClient) error {
	...
	mux.Handle("DELETE", pattern_AccommodationReserveService_DeleteAllUserReservations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/accommodation_reserve.AccommodationReserveService/DeleteAllUserReservations", runtime.WithHTTPPathPattern("/api/reservation/deleteAll/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AccommodationReserveService_DeleteAllUserReservations_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_AccommodationReserveService_DeleteAllUserReservations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "reservation", "deleteAll", "id"}, ""))
)
...
var (
	...
	forward_AccommodationReserveService_DeleteAllUserReservations_0 = runtime.ForwardResponseMessage
)
